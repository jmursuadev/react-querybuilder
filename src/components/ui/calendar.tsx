	...
	return (
		<DayPicker
			...
			classNames={{
				...
				table: "w-full border-collapse space-y-1 [&_.rdp-tbody_tr:first-child]:!mt-0",
				head_row: "flex",
				...
				day_selected:
					"!bg-primary !border-primary !text-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground !rounded-full",
